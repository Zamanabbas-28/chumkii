...
async function buildOrderItems(cartItems) {
  ...
  for (const item of cartItems) {
    ...
    const customization = {
      ...
      bigColorPreference: item.bigColorPreference || null,
      mediumColorPreference: item.mediumColorPreference || null,
      smallColorPreference: item.smallColorPreference || null,
      pieceColorPreference: item.pieceColorPreference || null,
      bigColorLabel: item.bigColorLabel || null,
      mediumColorLabel: item.mediumColorLabel || null,
      smallColorLabel: item.smallColorLabel || null,
      pieceColorLabel: item.pieceColorLabel || null,
      isOriginalColor: Boolean(item.isOriginalColor),
